...
class Cart(models.Model):
    ...
    sub_total = models.DecimalField(default=0.00,decimal_places=2,max_digits=10)
...
def m2m_change_cart_reciever(sender,action,instance,*args,**kwargs):
    if (action == 'post_add'
...
m2m_changed.connect(m2m_change_cart_reciever,sender=Cart.products.through)
